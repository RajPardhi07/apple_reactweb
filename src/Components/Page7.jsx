...
const page7 = () => {
  return (
    <div>
      <div className="relative w-[100%] h-[100vh] bg-gray-300  flex items-center justify-center">

        <div className="w-[70%] h-[95%]  mt-3">
          <div className="w-[100%] h-[40%] text-black-400">
          ...
          <div className="w-[100%] h-[60%] text-black">

            <div className="flex pl-[2vw]  justify-between">


              <div className="w-[6vw] h-[45vh] font-light	">
                Shop and Learn
                Store
                Mac
                iPad
              ...
              <div className="w-[6vw] text-[18px] font-light">
                Account
